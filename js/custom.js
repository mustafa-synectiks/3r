...
$(document).ready(function() {
  ...
  $('#menu').mmenu({
    ...
    footer: {
      add: true,
      title: 'Copyrights 2019 3R Biopharma. all rights reserved.'
    },
...
function validateContact() {
  ...
  if (first_name.value == '') {
    errors += 'Please Fill Mandatory Fields';
  }
  // else if (last_name.value == "") {
  //     errors += 'Please provide your Last name.';
  // }
  // else if (title_name.value == "") {
  //     errors += 'Please provide your Title name.';
  // }
