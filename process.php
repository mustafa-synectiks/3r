...
if(isset($_POST['contact_form']) != ""){
			...
			$message = "&nbsp;&nbsp;&nbsp;&nbsp;<strong>Name: </strong>".$_POST["department_name"]."<br />";
			$message = "&nbsp;&nbsp;&nbsp;&nbsp;<strong>First Name: </strong>".$_POST["first_name"]."<br />";
			$message = "&nbsp;&nbsp;&nbsp;&nbsp;<strong>Last Name: </strong>".$_POST["last_name"]."<br />";
			$message .= "&nbsp;&nbsp;&nbsp;&nbsp;<strong>Phone Number: </strong>".$_POST["contact_email"]."<br />";
